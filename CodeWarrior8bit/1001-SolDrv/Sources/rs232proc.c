 ...
 * 
 * Grab the serial character.  If a msg isn't being rcv'd, and char is STX, set
 * the rcv msg flag.  Otherwise drop the character.  If the msg rcv'd flag is set,
 * increment num chars in msg.  If that last char in the msg is rcv'd set the rcv
 * done flag.
 * 
 * @param   None 
 * @return  None
