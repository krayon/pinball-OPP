...
const U8 cfg[0xf0] = {
   /* First config is for solenoids, 0x30 in size, 2 flippers and 2 kickers */
   ...
   /* Second config is for inputs, 0x20 in size, state inputs */
   /* Entry 0        Entry 1           Entry 2           Entry 3 */
...
void debug_save_nv_cfg()
{
   ...
   gen2g_info.nvCfgInfo.nvCfg[0] = NVCFG_COLOR_TBL;
   gen2g_info.nvCfgInfo.nvCfg[1] = NVCFG_SOL;
   gen2g_info.nvCfgInfo.nvCfg[2] = NVCFG_INP;
   gen2g_info.nvCfgInfo.nvCfg[3] = NVCFG_UNUSED;
