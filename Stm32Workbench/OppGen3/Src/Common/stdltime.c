   ...
   STDLI_TIMER_E              params)        /* TIMER_POLL or TIMER_FAST_OSC */
{
   ...
   if ((stdltime_glob.params & TIMER_POLL) == 0)
   {
	   ...
	   // HRS timer interrupts not supported for now
   }
...
void stdltime_timer2_overflow(void)
{
   ...
   /* Clear terminal count isr pending bit */
   tim2Base_p->SR = 0;
