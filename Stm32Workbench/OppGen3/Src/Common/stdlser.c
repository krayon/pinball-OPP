 ...
 */
/**
 * Function for initializing serial data
 *
 * Initialize head/tail rcv pointers and transmit index
 *
 * @return  None
 *
 * @pre     None
   ...
   INT                        numChar)      /* Num chars to xmt */
{
   ...
   {
	   stdlser_glob.xmtData[stdlser_glob.xmtIndex++] = *data_p++;
   }
 ...
 * ===============================================================================
 *
 * Name: stdlser_get_xmt_info
 *
 * ===============================================================================
 */
/**
 * Function for getting transmit data information
 *
 * Return the xmt data pointer and the number of bytes to send..
 *
 * @param   data_p      [in]    Ptr to data to xmt
 * @param   numChar     [in]    Num chars to xmt
 * @return  None
...
void stdlser_get_xmt_info(
   U8                         **data_pp,    /* Ptr to ptr to data to xmt */
   U16                        *numChar_p)   /* Ptr to the num chars to xmt */
{
   *data_pp = &stdlser_glob.xmtData[0];
   *numChar_p = (U16)stdlser_glob.xmtIndex;
   stdlser_glob.xmtIndex = 0;
} /* End void stdlser_get_xmt_info */
