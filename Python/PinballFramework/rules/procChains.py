...
class ProcChain:
    ...
    PROC_CHAIN = [ 
        ...
        [State.ATTRACT, [], [RulesFunc.Proc_Init, RulesFunc.Proc_Add_Coin], LedChains.Attract, [], ImageChains.ImageAttract],
        [State.PRESS_START, [RulesFunc.Proc_Press_Start_Init], [RulesFunc.Proc_Start_and_Coin], LedChains.Attract, SoundChains.PressStart, []],
