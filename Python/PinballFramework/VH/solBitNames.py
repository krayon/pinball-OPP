...
class SolBitNames:
    ...
    SOL_BTM_POP                                      = 0x02000002
    SOL_LFT_SLING                                    = 0x02000004
    SOL_TOP_POP                                      = 0x02000008
    SOL_LFT_POP                                      = 0x02010001
    SOL_RGHT_SLING                                   = 0x02010002
    SOL_SAUCER                                       = 0x02010004
    SOL_OUTHOLE                                      = 0x02010008
    SOL_LFT_FLIPPER                                  = 0x03000001
    SOL_RGHT_FLIPPER                                 = 0x03000004

    SOL_DROP_BANK_CRD2MSK                            = 0x00000001
    SOL_BTM_POP_CRD2MSK                              = 0x00000002
    SOL_LFT_SLING_CRD2MSK                            = 0x00000004
    SOL_TOP_POP_CRD2MSK                              = 0x00000008
    SOL_LFT_POP_CRD2MSK                              = 0x00000100
    SOL_RGHT_SLING_CRD2MSK                           = 0x00000200
    SOL_SAUCER_CRD2MSK                               = 0x00000400
    SOL_OUTHOLE_CRD2MSK                              = 0x00000800
    SOL_LFT_FLIPPER_CRD3MSK                          = 0x00000001
    SOL_RGHT_FLIPPER_CRD3MSK                         = 0x00000004

    ## Solenoid board bit names
    # Indexed into using the [SolBitNames](@ref solBitNames.SolBitNames) class
    SOL_BRD_BIT_NAMES = [ [ ],
        [ ],
        ["DropBank", "BtmPop", "LftSling", "TopPop",
        "LftPop", "RghtSling", "Saucer", "Outhole",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused"],
        ["LftFlip", "Unused", "RghtFlip", "Unused",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused"] ]
    ...
    SOL_BRD_CFG = [ [ ],
        [ ],
        [rs232Intf.CFG_SOL_USE_MTRX_INP, '\x10', '\x05', rs232Intf.CFG_SOL_USE_MTRX_INP, '\x10', '\x26',
        ...
        rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
        rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00'],
        [rs232Intf.CFG_SOL_ON_OFF_USE_SW, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
        rs232Intf.CFG_SOL_ON_OFF_USE_SW, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
        rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
        rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
        rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00', rs232Intf.CFG_SOL_DISABLE, '\x00', '\x00',
