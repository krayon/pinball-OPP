...
class InpBitNames:
    ...
    MTRX_INP_OUTHOLE                                 = 0x02800001
    MTRX_INP_TILT1                                   = 0x02800002
    MTRX_INP_SUPER_STAR_TRGT                         = 0x02800008
    MTRX_INP_DROP_TRGT_1ST                           = 0x02800010
    MTRX_INP_DROP_TRGT_2X                            = 0x02800020
    MTRX_INP_DROP_TRGT_3X                            = 0x02800040
    MTRX_INP_DROP_TRGT_5X                            = 0x02800080
    MTRX_INP_SAUCER                                  = 0x02820001
    MTRX_INP_LFT_OUTLN                               = 0x02820002
    MTRX_INP_LFT_INLN                                = 0x02820004
    MTRX_INP_RGHT_INLN                               = 0x02820008
    ...
    MTRX_INP_D2_TRGT                                 = 0x02830010
    MTRX_INP_LFT_POP                                 = 0x02840001
    MTRX_INP_BTM_POP                                 = 0x02840002
    MTRX_INP_TOP_POP                                 = 0x02840004
    MTRX_INP_LFT_SLING                               = 0x02840008
    MTRX_INP_RGHT_SLING                              = 0x02840010
    MTRX_INP_PANAMA_ROLL                             = 0x02840020
    MTRX_INP_REBND                                   = 0x02840040
    MTRX_INP_TILT2                                   = 0x03800002
    MTRX_INP_CRDT_RST                                = 0x03800004
    MTRX_INP_SLAM                                    = 0x03810001
    MTRX_INP_COIN2                                   = 0x03810020
    MTRX_INP_COIN1                                   = 0x03810040
    MTRX_INP_COIN3                                   = 0x03810080
    ...
    INP_BRD_MTRX_BIT_NAMES = [ [ ],
        [ ],
        ["Outhole", "Tilt1", "Unused", "SuperStar",
        "1stDrop", "2xDrop", "3xDrop", "5xDrop",
        ...
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused"],
        ["Unused", "Tilt2", "CrdtRst", "Unused",
        "Unused", "Unused", "Unused", "Unused",
        "Slam", "Unused", "Unused", "Unused",
        "Unused", "Coin2", "Coin1", "Coin3",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused",
        "Unused", "Unused", "Unused", "Unused",
