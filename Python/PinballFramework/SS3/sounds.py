...
class Sounds():
    ...
    SOUND_APACHE_KID                         = 47
    SOUND_BILLY_KID                          = 48
    SOUND_BUTCH_CASSIDY                      = 49
    SOUND_SUNDANCE_KID                       = 50
    SOUND_GERONIMO                           = 51
    SOUND_JESSE_JAMES                        = 52
    SOUND_JOHN_HARDIN                        = 53
    SOUND_BALL_DRAIN_BANJO                   = 54
    SOUND_BALL_DRAIN_ORGAN                   = 55
    SOUND_BULLET                             = 56
    SOUND_DONE_JOB                           = 57
    SOUND_FINE_DESIGNERS                     = 58
    SOUND_GOIN_BOOT_HILL                     = 59
    SOUND_GRAB_REWARD                        = 60
    SOUND_GUN_RICOCHET                       = 61
    SOUND_HORSE_GALLOP                       = 62
    SOUND_HORSE_NEIGH                        = 63
    SOUND_LAST_TIME_PREORDER                 = 64
    SOUND_SKIT_B                             = 65
    ...
    SND_FILES = ["sounds/howdyFolks.wav", "sounds/yallComeBack.wav", "sounds/hellOfaShotMister.wav", "sounds/niceShootinTex.wav", "sounds/ding_ding.wav", 
        ...
        "sounds/Sheriff.wav", "sounds/Marshal.wav", "sounds/ApacheKid.wav", "sounds/BillyKid.wav", "sounds/ButchCassidy.wav", 
        "sounds/SundanceKid.wav", "sounds/Geronimo.wav", "sounds/JesseJames.wav", "sounds/JohnHardin.wav", "sounds/ballDrainBanjo.wav", 
        "sounds/ballDrainOrgan.wav", "sounds/bullet.wav", "sounds/DoneJob.wav", "sounds/FineDesigners.wav", "sounds/GoinBootHill.wav", 
        "sounds/GrabReward.wav", "sounds/gunRichochet.wav", "sounds/horseGallop.wav", "sounds/horseNeigh.wav", "sounds/LastTimePreOrder.wav", 
        "sounds/SkitB.wav", "sounds/WoaNellyCorral.wav"]
