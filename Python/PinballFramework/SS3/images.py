...
class Images():
    ...
    IMAGE_SALOON_GUY     = 2
    IMAGE_GUY_HIT        = 3
    IMAGE_GUY_SHOOTING   = 4

    ## Background images
    # Indexed into using the [Images](@ref images.Images) class
    BGND_GRAPHIC_FILES = ["graphics/sal_empty.jpg", "graphics/sal_girl.jpg", "graphics/sal_guy.jpg", "graphics/sal_guyShot.jpg", "graphics/sal_guyBang.jpg"]
